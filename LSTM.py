...
def index():
    if request.method == 'POST':
        ...
        return render_template('index.html', closing_graph=closing_graph, opening_graph=opening_graph, high_graph=high_graph,
    ...
    return render_template('index.html', closing_graph=None, opening_graph=None, high_graph=None, volume_graph=None,
